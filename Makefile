.PHONY: test_success test_fail_idempotency test_fail_negative_dimensions test_fail_missing_dimensions test_fail_future_timestamp test_fail_missing_tracking_id test_warn_small_dimensions test_warn_absurd_height test_all_validations
